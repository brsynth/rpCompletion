...
class Module(Main):
    ...
    files = [
    (tempdir.name+'/'+'rp_1_11_sbml.xml',  32358),
    (tempdir.name+'/'+'rp_1_1_sbml.xml',   32640),
    (tempdir.name+'/'+'rp_1_6_sbml.xml',   32225),
    (tempdir.name+'/'+'rp_2_12_sbml.xml',  32355),
    (tempdir.name+'/'+'rp_2_22_sbml.xml',  32483),
    (tempdir.name+'/'+'rp_2_2_sbml.xml',   32765),
    (tempdir.name+'/'+'rp_3_10_sbml.xml',  33763),
    (tempdir.name+'/'+'rp_3_131_sbml.xml', 34551),
    (tempdir.name+'/'+'rp_3_132_sbml.xml', 34814),
    (tempdir.name+'/'+'rp_3_140_sbml.xml', 33353),
    (tempdir.name+'/'+'rp_3_1_sbml.xml',   34956),
    (tempdir.name+'/'+'rp_3_261_sbml.xml', 34680),
    (tempdir.name+'/'+'rp_3_262_sbml.xml', 34942),
    (tempdir.name+'/'+'rp_3_270_sbml.xml', 33482),
    (tempdir.name+'/'+'rp_3_2_sbml.xml',   35220),
    ]
